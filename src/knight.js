...
// scene.fog = new THREE.Fog( 0xcce0ff, -25, 10)   //加上雾化的效果
...
const light0 = new THREE.PointLight( 0xffffff, 1, 100, 10 );
                light0.position.set(10, 20, 20);
                light0.castShadow = true;
                scene.add( light0 );

                const helper = new THREE.PointLightHelper( light0, 1 );
                scene.add( helper );
...
loader.load('knight/scene.gltf', (gltf)=>{
    console.log(gltf);
